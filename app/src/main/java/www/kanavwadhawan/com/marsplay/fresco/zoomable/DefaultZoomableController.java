...
package www.kanavwadhawan.com.marsplay.fresco.zoomable;
...
import www.kanavwadhawan.com.marsplay.fresco.gestures.TransformGestureDetector;
...
public class DefaultZoomableController
  ...
  private DefaultZoomableController(TransformGestureDetector gestureDetector) {
  ...
  private void limitScale(float pivotX, float pivotY) {
    float currentScale = getScaleFactor();
      ...
      float scale = minScaleFactor / currentScale;
